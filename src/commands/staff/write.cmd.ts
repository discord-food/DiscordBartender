...
export const command = new Command("write", "Backdoor command. Send a message in a channel.", [], ["rd"], [{ type: String, name: "id", required: true }, { type: String, name: "msg", required: true }] as const, permissions.botModerator)
